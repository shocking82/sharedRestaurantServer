...
import com.johnsong.android.spring.jooq.information_schema.tables.records.ColumnsRecord;
...
public class Columns extends TableImpl<ColumnsRecord> {
    ...
    private static final long serialVersionUID = 995104934;
     ...
     */
    public final TableField<ColumnsRecord, String> EXTRA = createField("EXTRA", org.jooq.impl.SQLDataType.VARCHAR(27).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
