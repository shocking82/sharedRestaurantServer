...
import com.johnsong.android.spring.jooq.information_schema.tables.records.EnabledRolesRecord;
...
public class EnabledRoles extends TableImpl<EnabledRolesRecord> {
    ...
    private static final long serialVersionUID = -960728684;
     ...
     */
    public final TableField<EnabledRolesRecord, String> ROLE_NAME = createField("ROLE_NAME", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
