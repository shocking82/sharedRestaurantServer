...
import com.johnsong.android.spring.jooq.information_schema.tables.records.RoutinesRecord;
...
public class Routines extends TableImpl<RoutinesRecord> {
    ...
    private static final long serialVersionUID = 49780537;
     ...
     */
    public final TableField<RoutinesRecord, String> ROUTINE_TYPE = createField("ROUTINE_TYPE", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
