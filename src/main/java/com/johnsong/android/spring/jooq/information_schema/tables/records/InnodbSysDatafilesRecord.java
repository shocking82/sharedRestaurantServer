...
public class InnodbSysDatafilesRecord extends TableRecordImpl<InnodbSysDatafilesRecord> implements Record2<UInteger, String> {
    ...
    private static final long serialVersionUID = -1156265664;

    /**
     * Setter for <code>information_schema.INNODB_SYS_DATAFILES.SPACE</code>.
     */
    public InnodbSysDatafilesRecord setSpace(UInteger value) {
        set(0, value);
        return this;
    }
     ...
     */
    public InnodbSysDatafilesRecord setPath(String value) {
        set(1, value);
        return this;
    }
