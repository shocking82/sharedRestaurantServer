...
public class City extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -1051477830;
     ...
     */
    public final TableField<Record, Integer> CITY_ID = createField("city_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>banana.City.city_name</code>.
     */
    public final TableField<Record, String> CITY_NAME = createField("city_name", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
